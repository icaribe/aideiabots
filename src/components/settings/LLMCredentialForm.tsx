...
import { createProviderCredential, updateProviderCredential, validateLLMProviderApiKey } from "@/services/providerCredentials";

type LLMCredentialFormProps = {
  credential?: LLMProviderCredential;
  onSaved: () => void;
  onCancel: () => void;
};

export const LLMCredentialForm = ({
  credential,
  onSaved,
  onCancel
}: LLMCredentialFormProps) => {
